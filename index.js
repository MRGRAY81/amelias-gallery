 ...
 * =========================
 * Not full JWT, but secure enough for MVP:
...
/**
 * Upload (admin only)
 * Accepts: file + title + category
 * Adds to gallery.json and returns the new item
 */
 ...
 * Supports multipart: refs (up to 3 images), plus fields.
 */
